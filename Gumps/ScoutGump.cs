...
namespace Server.Gumps
{
	public class ScoutGump : Gump
	{
		...
		public ScoutGump( Mobile owner, string filter ) : this( owner, BuildList( owner, filter ), 0 )
		{
		}

		public ScoutGump( Mobile owner, List<Mobile> list, int page ) : base( GumpOffsetX, GumpOffsetY )
		{
			m_Owner = owner;
			m_Mobiles = list;
