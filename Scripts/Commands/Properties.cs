    ...
    public sealed class Property
    {
        ...
        public Type Type
        {
            get
            {
                ...
                return this.m_Chain[this.m_Chain.Length - 1].PropertyType;
            }
        }
        ...
        public bool CheckAccess(Mobile from)
        {
            ...
            {
                PropertyInfo prop = this.m_Chain[i];

                bool isFinal = (i == (this.m_Chain.Length - 1));

                PropertyAccess access = this.m_Access;
        ...
        public void BindTo(Type objectType, PropertyAccess desiredAccess)
        {
            ...
            string[] split = this.m_Binding.Split('.');
        ...
        public override string ToString()
        {
            ...
            string[] toJoin = new string[this.m_Chain.Length];

            for (int i = 0; i < toJoin.Length; ++i)
                toJoin[i] = this.m_Chain[i].Name;
