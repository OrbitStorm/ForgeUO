    ...
    public abstract class BaseHouse : BaseMulti
    {
        ...
        public void SetDynamicDecay(DecayLevel level)
        {
            ...
            if (DynamicDecay.Decays(level))
                this.m_NextDecayStage = DateTime.Now + DynamicDecay.GetRandomDuration(level);
            else
                this.m_NextDecayStage = DateTime.MinValue;
        }
        ...
        public virtual DecayLevel DecayLevel
        {
            get
            {
                ...
                if (!this.CanDecay)
                {
                    ...
                    this.m_LastRefreshed = DateTime.Now;
                ...
                else if (DynamicDecay.Enabled)
                {
                    ...
                    if (stage == DecayLevel.Ageless || (DynamicDecay.Decays(stage) && this.m_NextDecayStage <= DateTime.Now))
        ...
        {
            TimeSpan timeAfterRefresh = DateTime.Now - this.m_LastRefreshed;
        ...
        private class TransferItem : Item
        {
            ...
            public override void OnSecureTrade(Mobile from, Mobile to, Mobile newOwner, bool accepted)
            {
                ...
                */
                ...
                this.m_House.LastTraded = DateTime.Now;
            }
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (version < 11)
                this.m_LastRefreshed = DateTime.Now + TimeSpan.FromHours(24 * Utility.RandomDouble());
