    ...
    { 
        ...
        public override void OnCast()
        {
            ...
            else if (this.CheckSequence())
            {
                ...
                // Skill
                this.Caster.AddSkillMod(new TimedSkillMod(SkillName.MagicResist, true, -40, DateTime.Now + TimeSpan.FromSeconds(span)));
        ...
        private class InternalTimer : Timer
        {
            ...
            {
                this.m_Owner = owner;
                this.m_Expire = DateTime.Now + duration;
            }

            protected override void OnTick()
            {
                if (DateTime.Now >= this.m_Expire)
                {
