...
namespace Server.Mobiles
{
    public class MageAI : BaseAI
    {
        ...
        public override bool DoActionCombat()
        {
            ...
            if (this.m_Mobile.Spell == null && DateTime.Now > this.m_NextCastTime && this.m_Mobile.InRange(c, Core.ML ? 10 : 12))
            {
                ...
                this.m_NextCastTime = DateTime.Now + this.GetDelay(spell);
            }
        ...
        public override bool DoActionGuard()
        {
            if (this.m_LastTarget != null && this.m_LastTarget.Hidden)
            {
                ...
                else if (this.m_Mobile.Spell == null && DateTime.Now > this.m_NextCastTime)
                {
