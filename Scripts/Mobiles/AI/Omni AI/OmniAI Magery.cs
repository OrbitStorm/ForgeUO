...
namespace Server.Mobiles
{
    public partial class OmniAI : BaseAI
    {
        ...
        public void MageryPower()
        {
            ...
            if (spell != null)
            {
                this.m_NextCastTime = DateTime.Now + spell.GetCastDelay() + spell.GetCastRecovery();
                spell.Cast();
            }
        ...
        public Spell GetRandomMageryDamageSpell()
        {
            ...
            switch( whichone )
            {
                ...
                case 5:
                    {
                        if (DateTime.Now > this.m_LastExplosion)
                        {
                            this.m_LastExplosion = DateTime.Now + TimeSpan.FromSeconds(3);
