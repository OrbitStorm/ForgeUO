    ...
    public partial class OmniAI : BaseAI
    {
        ...
        public bool TryToHeal()
        {
            if (this.m_Mobile.Summoned)
                return false;
            else if (DateTime.Now < this.m_NextHealTime)
                return false;
            ...
            Spell spell = null;
            this.m_NextHealTime = DateTime.Now + TimeSpan.FromSeconds(20);
            ...
            else if (this.m_CanUseNecromancy)
            {
                ...
                this.m_NextHealTime = DateTime.Now + TimeSpan.FromSeconds(10);
            }
            ...
            else if (this.m_Mobile.Skills[SkillName.Healing].Value > 10.0)
            {
                ...
                this.m_NextHealTime = DateTime.Now + TimeSpan.FromSeconds(delay + 1);
                return true;
            }
        ...
        {
            if (DateTime.Now > this.m_NextWeaponSwap)
                return;
            ...
            this.m_NextWeaponSwap = DateTime.Now + TimeSpan.FromSeconds(15);
        }
