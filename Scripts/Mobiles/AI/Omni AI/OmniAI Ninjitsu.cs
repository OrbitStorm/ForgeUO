...
namespace Server.Mobiles
{
    public partial class OmniAI : BaseAI
    {
        ...
        public void NinjitsuPower()
        {
            ...
            if (DateTime.Now > this.m_NextShurikenThrow && this.m_Mobile.Combatant != null && this.m_Mobile.InRange(this.m_Mobile.Combatant, 12))
            {
                if (this.m_Mobile.Debug)
                ...
                this.m_NextShurikenThrow = DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(5, 15));
            }
        }
