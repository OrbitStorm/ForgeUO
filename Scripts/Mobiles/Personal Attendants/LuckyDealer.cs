        ...
        private class InternalGump : Gump
        {
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                ...
                if (info.ButtonID == 1)
                {
                    ...
                    if (this.m_Dealer.m_NextUse < DateTime.Now)
                    {
                        if (dice > 0 && faces > 0)
                        {
                            int sum = 0;
                        ...
                        if (this.m_Dealer.m_Count > 0 && DateTime.Now - this.m_Dealer.m_NextUse < TimeSpan.FromSeconds(this.m_Dealer.m_Count))
                            this.m_Dealer.m_NextUse = DateTime.Now + TimeSpan.FromSeconds(3);

                        if (this.m_Dealer.m_Count++ == 5)
                        {
                            this.m_Dealer.m_NextUse = DateTime.Now;
