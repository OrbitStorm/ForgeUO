...
namespace Server.Mobiles
{
    ...
    { 
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            {
                if (this.ControlOrder == OrderType.Follow && this.m_NextYell < DateTime.Now && m != this.ControlMaster && this.m_Announcement != null)
                {
                    this.m_Announcement.Say(this, m);
                    this.m_NextYell = DateTime.Now + this.YellDelay + TimeSpan.FromSeconds(Utility.RandomMinMax(-2, 2));
                }
