...
namespace Server.Mobiles
{
    ...
    public class RentedVendor : PlayerVendor
    {
            ...
            : base(owner, house)
        {
            ...
            this.m_RentalExpireTime = DateTime.Now + duration.Duration;
        ...
        {
            TimeSpan delay = this.RentalExpireTime - DateTime.Now;
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            TimeSpan delay = this.m_RentalExpireTime - DateTime.Now;
        ...
        private class RentalExpireTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                if (this.m_Vendor.Renew && this.m_Vendor.HoldGold >= renewalPrice)
                {
                    ...
                    this.m_Vendor.m_RentalExpireTime = DateTime.Now + this.m_Vendor.RentalDuration.Duration;
                }
                else
                {
