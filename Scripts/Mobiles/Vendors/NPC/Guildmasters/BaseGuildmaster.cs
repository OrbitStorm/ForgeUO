        ...
        public override void OnSpeech(SpeechEventArgs e)
        {
            ...
            if (!e.Handled && from is PlayerMobile && from.InRange(this.Location, 2) && this.WasNamed(e.Speech))
            {
                ...
                if (e.HasKeyword(0x0004)) // *join* | *member*
                {
                    ...
                    else if (pm.GameTime < this.JoinGameAge || (pm.CreationTime + this.JoinAge) > DateTime.Now)
                ...
                else if (e.HasKeyword(0x0005)) // *resign* | *quit*
                {
                    ...
                    else if ((pm.NpcGuildJoinTime + this.QuitAge) > DateTime.Now || (pm.NpcGuildGameTime + this.QuitGameAge) > pm.GameTime)
                    {
