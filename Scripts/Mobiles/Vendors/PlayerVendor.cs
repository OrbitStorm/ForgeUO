    ...
    public class PlayerVendor : Mobile
    {
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            if (version < 1 || newVendorSystemActivated)
            {
                ...
                this.m_NextPayTime = DateTime.Now + PayTimer.GetInterval();
            ...
            TimeSpan delay = this.m_NextPayTime - DateTime.Now;
        ...
        {
            return this.SetVendorItem(item, price, description, DateTime.Now);
        }
        ...
        private class PayTimer : Timer
        {
            ...
            {
                this.m_Vendor.m_NextPayTime = DateTime.Now + this.Interval;
