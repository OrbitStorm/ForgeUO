...
namespace Server.Mobiles
{
    ...
    public class Betrayer : BaseCreature
    {
            ...
            : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.m_NextAbilityTime = DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(5, 30));
        }
        ...
        public override void OnActionCombat()
        {
            ...
            if (DateTime.Now < this.m_NextAbilityTime || combatant == null || combatant.Deleted || combatant.Map != this.Map || !this.InRange(combatant, 3) || !this.CanBeHarmful(combatant) || !this.InLOS(combatant))
                return;
