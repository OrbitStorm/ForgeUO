...
namespace Server.Mobiles
{
    ...
    public class PlagueSpawn : BaseCreature
    {
        ...
        {
            this.m_Owner = owner;
            this.m_ExpireTime = DateTime.Now + TimeSpan.FromMinutes(1.0);
        ...
        {
            if (this.m_Owner != null && (DateTime.Now >= this.m_ExpireTime || this.m_Owner.Deleted || this.Map != this.m_Owner.Map || !this.InRange(this.m_Owner, 16)))
            {
