...
namespace Server.Mobiles
{
    ...
    public class MLDryad : BaseCreature
    {
        ...
        {
            if (this.Combatant == null || this.Deleted || !this.Alive || this.m_NextPeace > DateTime.Now || 0.1 < Utility.RandomDouble())
                return;
        ...
        {
            if (this.Combatant == null || this.Deleted || !this.Alive || this.m_NextUndress > DateTime.Now || 0.005 < Utility.RandomDouble())
                return;
