...
{ 
    ...
    { 
        ...
        public override void OnMovement(Mobile from, Point3D oldLocation)
        {
            ...
            {
                if (!from.Frozen && (DateTime.Now >= this.m_NextResurrect) && this.InRange(from, 4) && !this.InRange(oldLocation, 4) && this.InLOS(from))
                {
                    this.m_NextResurrect = DateTime.Now + ResurrectDelay;
