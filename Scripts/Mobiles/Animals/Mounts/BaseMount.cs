...
namespace Server.Mobiles
{
    ...
    public abstract class BaseMount : BaseCreature, IMount
    {
        ...
        public virtual void OnRiderDamaged(int amount, Mobile from, bool willKill)
        {
            ...
            if (!(attacker == this || attacker == this.m_Rider || willKill || DateTime.Now < this.m_NextMountAbility))
            {
                if (this.DoMountAbility(amount, from))
                    this.m_NextMountAbility = DateTime.Now + this.MountAbilityDelay;
            }
        }
        ...
        private class BlockEntry
        {
            ...
            public bool IsExpired
            {
                get
                {
                    return (DateTime.Now >= this.m_Expiration);
                }
            }
        }
    }
