    ...
    public class Kepetch : BaseCreature, ICarvable
    {
        ...
        public DateTime NextWoolTime
        {
            ...
            set
            {
                ...
                this.Body = (DateTime.Now >= this.m_NextWoolTime) ? 0xCF : 0xDF;
            }
        }
        ...
        {
            if (DateTime.Now < this.m_NextWoolTime)
            {
            ...
            this.NextWoolTime = DateTime.Now + TimeSpan.FromHours(3.0); // TODO: Proper time delay
        }

        public override void OnThink()
        {
            base.OnThink();
            this.Body = (DateTime.Now >= this.m_NextWoolTime) ? 726 : 727;
        }
