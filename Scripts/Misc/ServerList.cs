...
namespace Server.Misc
{
    public class ServerList
    {
        ...
        * are private network addresses and AutoDetect is 'true' then AdaptUO will attempt to discover your public IP address
        ...
        * a hostname that will be resolved when AdaptUO starts.
        * 
