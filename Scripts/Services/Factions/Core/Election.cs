...
namespace Server.Factions
{
    ...
    public class Election
    {
        ...
        public ElectionState State
        {
            ...
            {
                this.m_State = value;
                this.m_LastStateTime = DateTime.Now;
            }
        }
        ...
        public TimeSpan NextStateTime
        {
            get
            {
                ...
                TimeSpan until = (this.m_LastStateTime + period) - DateTime.Now;
            ...
            set
            {
                ...
                this.m_LastStateTime = DateTime.Now - period + value;
            }
        }
        ...
        public void Slice()
        {
            ...
            switch ( this.m_State )
            {
                case ElectionState.Pending:
                    {
                        if ((this.m_LastStateTime + PendingPeriod) > DateTime.Now)
                            break;
                ...
                case ElectionState.Campaign:
                    {
                        if ((this.m_LastStateTime + CampaignPeriod) > DateTime.Now)
                            break;
                ...
                case ElectionState.Election:
                    {
                        if ((this.m_LastStateTime + VotingPeriod) > DateTime.Now)
                            break;
