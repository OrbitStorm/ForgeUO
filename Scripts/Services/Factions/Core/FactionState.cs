    ...
    public class FactionState
    {
        ...
        public bool FactionMessageReady
        {
            get
            {
                ...
                {
                    if (DateTime.Now >= (this.m_LastBroadcasts[i] + BroadcastPeriod))
                        return true;
                }
        ...
        public bool IsAtrophyReady
        {
            get
            {
                return DateTime.Now >= (this.m_LastAtrophy + TimeSpan.FromHours(47.0));
            }
        }
        ...
        {
            if (DateTime.Now < (this.m_LastAtrophy + TimeSpan.FromHours(47.0)))
                return 0;
        ...
        public void RegisterBroadcast()
        {
            for (int i = 0; i < this.m_LastBroadcasts.Length; ++i)
            {
                if (DateTime.Now >= (this.m_LastBroadcasts[i] + BroadcastPeriod))
                {
                    this.m_LastBroadcasts[i] = DateTime.Now;
                    break;
                }
            }
        }
