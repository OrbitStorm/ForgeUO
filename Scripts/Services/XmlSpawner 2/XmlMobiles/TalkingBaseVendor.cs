...
namespace Server.Mobiles
{
    public abstract class TalkingBaseVendor : BaseVendor
    {
        ...
        public TalkingBaseVendor(Serial serial)
            : base(serial)
        {
        }
        ...
        public override void OnThink()
        {
            ...
            if (this.lasteffect + TimeSpan.FromSeconds(1) < DateTime.Now)
            {
        ...
        private class TalkEntry : ContextMenuEntry
        {
            ...
            public TalkEntry(TalkingBaseVendor npc)
                : base(6146)
            {
                this.m_NPC = npc;
            }
