...
namespace Server.Engines.XmlSpawner2
{
    public class XmlSiege : XmlAttachment
    {
        ...
        public TimeSpan NextAutoRepair
        {
            get
            {
                if (this.m_AutoRepairTimer != null && this.m_AutoRepairTimer.Running)
                    return this.m_AutoRepairEnd - DateTime.Now;
                else
        ...
        {
            this.m_AutoRepairEnd = DateTime.Now + delay;
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            if (this.m_AutoRepairEnd > DateTime.Now)
            {
                writer.Write(this.m_AutoRepairEnd - DateTime.Now);
            }
            else
            {
