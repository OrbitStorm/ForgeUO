    ...
    public class XmlFindGump : Gump
    {
            ...
            : base(X, Y)
        {
            ...
            if (from != null && !from.Deleted)
            {
                ...
                if (firststart)
                {
                    this.StartingMap = from.Map;
                    this.StartingLoc = from.Location;
                }
            }
            ...
            this.m_ShowExtension = extension;
            this.Descendingsort = descend;

            this.m_SearchCriteria = criteria;

            if (this.m_SearchCriteria == null)
            ...
            {
                this.AddBackground(0, 0, 170, height, 5054);
                this.AddAlphaRegion(0, 0, 170, height);
            }
            ...
            y = 5;
            // add the Sort button
            this.AddButton(5, y, 0xFAB, 0xFAD, 700, GumpButtonType.Reply, 0);
            this.AddLabel(38, y, 0x384, "Sort");

            // add the sort direction button
            if (this.Descendingsort)
            {
                this.AddButton(75, y + 3, 0x15E2, 0x15E6, 701, GumpButtonType.Reply, 0);
                this.AddLabel(95, y, 0x384, "descend");
            }
            else
            {
                this.AddButton(75, y + 3, 0x15E0, 0x15E4, 701, GumpButtonType.Reply, 0);
                this.AddLabel(95, y, 0x384, "ascend");
            }
            y += 22;
            // add the Sort on type toggle
            this.AddRadio(5, y, 0xD2, 0xD3, this.Sorttype, 0);
            this.AddLabel(28, y, 0x384, "type");

            // add the Sort on name toggle
            this.AddRadio(75, y, 0xD2, 0xD3, this.Sortname, 1);
            this.AddLabel(98, y, 0x384, "name");

            y += 20;
            // add the Sort on range toggle
            this.AddRadio(5, y, 0xD2, 0xD3, this.Sortrange, 2);
            this.AddLabel(28, y, 0x384, "range");

            // add the Sort on map toggle
            this.AddRadio(75, y, 0xD2, 0xD3, this.Sortmap, 4);
            this.AddLabel(98, y, 0x384, "map");

            y += 20;
            // add the Sort on selected toggle
            this.AddRadio(5, y, 0xD2, 0xD3, this.Sortselect, 5);
            this.AddLabel(28, y, 0x384, "select");
            ...
            this.AddButton(5, y, 0xFA8, 0xFAA, 3, GumpButtonType.Reply, 0);
            this.AddLabel(38, y, 0x384, "Search");

            y += 20;
            // add the map buttons
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchint, 312);
            this.AddLabel(28, y, 0x384, "Int");
            this.AddCheck(75, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchnull, 314);
            this.AddLabel(98, y, 0x384, "Null");

            y += 20;
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchfel, 308);
            this.AddLabel(28, y, 0x384, "Fel");
            this.AddCheck(75, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchtram, 309);
            this.AddLabel(98, y, 0x384, "Tram");

            y += 20;
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchmal, 310);
            this.AddLabel(28, y, 0x384, "Mal");
            this.AddCheck(75, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchilsh, 311);
            this.AddLabel(98, y, 0x384, "Ilsh");

            y += 20;
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchtok, 318);
            this.AddLabel(28, y, 0x384, "Tok");
            this.AddCheck(75, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchter, 327);
            this.AddLabel(98, y, 0x384, "Ter");

            y += 20;
            // add the hide valid internal map button
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dohidevalidint, 316);
            this.AddLabel(28, y, 0x384, "Hide valid internal");
            ...
            this.AddLabel(28, y, 0x384, "region");
            this.AddImageTiled(70, y, 68, 19, 0xBBC);
            this.AddTextEntry(70, y, 250, 19, 0, 106, this.m_SearchCriteria.Searchregion);
            // add the toggle to enable search region
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchregion, 319);

            y += 20;
            // add the search age entry
            this.AddLabel(28, y, 0x384, "age");
            //AddImageTiled( 80, 220, 50, 23, 0x52 );
            this.AddImageTiled(70, y, 45, 19, 0xBBC);
            this.AddTextEntry(70, y, 45, 19, 0, 105, this.m_SearchCriteria.Searchage.ToString());
            this.AddLabel(117, y, 0x384, "Hrs");
            // add the toggle to enable search age
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchage, 303);
            // add the toggle to set the search age test direction
            this.AddCheck(50, y + 2, 0x1467, 0x1468, this.m_SearchCriteria.Searchagedirection, 302);

            y += 20;
            // add the search range entry
            this.AddLabel(28, y, 0x384, "range");
            this.AddImageTiled(70, y, 45, 19, 0xBBC);
            this.AddTextEntry(70, y, 45, 19, 0, 100, this.m_SearchCriteria.Searchrange.ToString());
            // add the toggle to enable search range
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchrange, 304);

            y += 20;
            // add the search type entry
            this.AddLabel(28, y, 0x384, "type");
            // add the toggle to enable search by type
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchtype, 305);
            //AddImageTiled( 5, 285, 135, 23, 0x52 );
            this.AddImageTiled(6, y + 20, 132, 19, 0xBBC);
            this.AddTextEntry(6, y + 20, 250, 19, 0, 101, this.m_SearchCriteria.Searchtype);

            // add the search for attachments button
            this.AddLabel(100, y, 0x384, "attach");
            // add the toggle to enable search by attachment
            this.AddCheck(77, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchwithattach, 317);

            y += 41;
            // add the search condition entry
            this.AddLabel(28, y, 0x384, "property test");
            // add the toggle to enable search by condition
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchcondition, 315);
            //AddImageTiled( 5, 285, 135, 23, 0x52 );
            this.AddImageTiled(6, y + 20, 132, 19, 0xBBC);
            this.AddTextEntry(6, y + 20, 500, 19, 0, 104, this.m_SearchCriteria.Searchcondition);

            y += 41;
            // add the search name entry
            this.AddLabel(28, y, 0x384, "name");
            // add the toggle to enable search by name
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchname, 306);
            //AddImageTiled( 5, 350, 135, 23, 0x52 );
            this.AddImageTiled(6, y + 20, 132, 19, 0xBBC);
            this.AddTextEntry(6, y + 20, 250, 19, 0, 102, this.m_SearchCriteria.Searchname);

            y += 41;
            // add the search attachment type entry
            this.AddLabel(28, y, 0x384, "attachment type");
            // add the toggle to enable search by attachment type
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchattach, 325);
            //AddImageTiled( 5, 285, 135, 23, 0x52 );
            this.AddImageTiled(6, y + 20, 132, 19, 0xBBC);
            this.AddTextEntry(6, y + 20, 250, 19, 0, 125, this.m_SearchCriteria.Searchattachtype);

            y += 41;
            // add the search spawner entries
            this.AddLabel(28, y, 0x384, "entry");
            // add the toggle to enable search spawner entries
            this.AddCheck(5, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchspawnentry, 307);

            // add the search spawner entries by type
            this.AddLabel(88, y, 0x384, "type");
            // add the toggle to enable search spawner entry types
            this.AddCheck(65, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearchspawntype, 326);

            //AddImageTiled( 5, 415, 135, 23, 0x52 );
            this.AddImageTiled(6, y + 20, 132, 19, 0xBBC);
            this.AddTextEntry(6, y + 20, 250, 19, 0, 103, this.m_SearchCriteria.Searchspawnentry);

            // add the search spawner errors
            this.AddLabel(140, y, 0x384, "err");
            // add the toggle to enable search spawner entries
            this.AddCheck(117, y, 0xD2, 0xD3, this.m_SearchCriteria.Dosearcherr, 313);
            ...
            this.AddButton(72, y, 0xFAE, 0xFAF, 155, GumpButtonType.Reply, 0);
            this.AddLabel(105, y, 0x384, "Return");

            y = height - 25;
            // add the Bring button
            this.AddButton(5, y, 0xFAE, 0xFAF, 154, GumpButtonType.Reply, 0);
            this.AddLabel(38, y, 0x384, "Bring");

            // add gump extension button
            if (this.m_ShowExtension)
            {
                this.AddButton(720, y + 5, 0x15E3, 0x15E7, 200, GumpButtonType.Reply, 0);
            }
            else
            {
                this.AddButton(150, y + 5, 0x15E1, 0x15E5, 200, GumpButtonType.Reply, 0);
            }

            if (this.m_ShowExtension)
            {
                this.AddLabel(143, 5, 0x384, "Gump");
                this.AddLabel(178, 5, 0x384, "Prop");
                this.AddLabel(210, 5, 0x384, "Goto");
                this.AddLabel(250, 5, 0x384, "Name");
                this.AddLabel(365, 5, 0x384, "Type");
                this.AddLabel(460, 5, 0x384, "Location");
                this.AddLabel(578, 5, 0x384, "Map");
                this.AddLabel(650, 5, 0x384, "Owner");

                // add the Delete button
                this.AddButton(150, y, 0xFB1, 0xFB3, 156, GumpButtonType.Reply, 0);
                this.AddLabel(183, height - 25, 0x384, "Delete");

                // add the Reset button
                this.AddButton(230, y, 0xFA2, 0xFA3, 157, GumpButtonType.Reply, 0);
                this.AddLabel(263, y, 0x384, "Reset");

                // add the Respawn button
                this.AddButton(310, y, 0xFA8, 0xFAA, 158, GumpButtonType.Reply, 0);
                this.AddLabel(343, y, 0x384, "Respawn");

                // add the xmlsave entry
                this.AddButton(150, y - 25, 0xFA8, 0xFAA, 159, GumpButtonType.Reply, 0);
                this.AddLabel(183, y - 25, 0x384, "Save to file:");

                this.AddImageTiled(270, y - 25, 180, 19, 0xBBC);
                this.AddTextEntry(270, y - 25, 180, 19, 0, 300, this.SaveFilename);

                // add the commandstring entry
                this.AddButton(470, y - 25, 0xFA8, 0xFAA, 160, GumpButtonType.Reply, 0);
                this.AddLabel(503, y - 25, 0x384, "Command:");

                this.AddImageTiled(560, y - 25, 180, 19, 0xBBC);
                this.AddTextEntry(560, y - 25, 180, 19, 0, 301, this.CommandString);

                // add the page buttons
                for (int i = 0; i < (int)(MaxEntries / MaxEntriesPerPage); i++)
                {
                    //AddButton( 38+i*30, 365, 2206, 2206, 0, GumpButtonType.Page, 1+i );
                    this.AddButton(418 + i * 25, height - 25, 0x8B1 + i, 0x8B1 + i, 0, GumpButtonType.Page, 1 + i);
                }

                // add the advance pageblock buttons
                this.AddButton(415 + 25 * (int)(MaxEntries / MaxEntriesPerPage), height - 25, 0x15E1, 0x15E5, 201, GumpButtonType.Reply, 0); // block forward
                this.AddButton(395, height - 25, 0x15E3, 0x15E7, 202, GumpButtonType.Reply, 0); // block backward

                // add the displayfrom entry
                this.AddLabel(460, y, 0x384, "Display");
                this.AddImageTiled(500, y, 60, 21, 0xBBC);
                this.AddTextEntry(501, y, 60, 21, 0, 400, this.DisplayFrom.ToString());
                this.AddButton(560, y, 0xFAB, 0xFAD, 9998, GumpButtonType.Reply, 0);

                // display the item list
                if (this.m_SearchList != null)
                {
                    this.AddLabel(180, y - 50, 68, String.Format("Found {0} items/mobiles", this.m_SearchList.Count));
                    this.AddLabel(400, y - 50, 68, String.Format("Displaying {0}-{1}", this.DisplayFrom,
                    ...
                    int count = 0;
                    foreach (SearchEntry e in this.m_SearchList)
                    {
                        if (e.Selected)
                            count++;
                    }
                    this.AddLabel(600, y - 50, 33, String.Format("Selected {0}", count));
                }

                // display the select-all-displayed toggle
                this.AddButton(730, 5, 0xD2, 0xD3, 3999, GumpButtonType.Reply, 0);

                this.AddLabel(610, y, 0x384, "Select All");
                // display the select-all toggle
                this.AddButton(670, y, (this.SelectAll ? 0xD3 : 0xD2), (this.SelectAll ? 0xD2 : 0xD3), 3998, GumpButtonType.Reply, 0);
                ...
                for (int i = 0; i < MaxEntries; i++)
                {
                    ...
                    SearchEntry e = (SearchEntry)this.m_SearchList[index];
                    ...
                    this.AddImageTiled(235, 22 * (i % MaxEntriesPerPage) + 30, 386, 23, 0x52);
                    this.AddImageTiled(236, 22 * (i % MaxEntriesPerPage) + 31, 384, 21, 0xBBC);

                    // add the Goto button for each entry
                    this.AddButton(205, 22 * (i % MaxEntriesPerPage) + 30, 0xFAE, 0xFAF, 1000 + i, GumpButtonType.Reply, 0);
                    ...
                    {
                        this.AddButton(145, 22 * (i % MaxEntriesPerPage) + 30, 0xFBD, 0xFBE, 2000 + i, GumpButtonType.Reply, 0);
                    }

                    // add the Props button for each entry
                    this.AddButton(175, 22 * (i % MaxEntriesPerPage) + 30, 0xFAB, 0xFAD, 3000 + i, GumpButtonType.Reply, 0);
                    ...
                    // display the name
                    this.AddLabelCropped(248, 22 * (i % MaxEntriesPerPage) + 31, 110, 21, texthue, namestr);

                    // display the attachment button if it has attachments
                    if (XmlAttach.HasAttachments(o))
                    {
                        this.AddButton(238, 22 * (i % MaxEntriesPerPage) + 35, 2103, 2103, 5000 + i, GumpButtonType.Reply, 0);
                    }

                    // display the type
                    this.AddImageTiled(360, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, 0xBBC);
                    this.AddLabelCropped(360, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, texthue, typestr);
                    // display the loc
                    this.AddImageTiled(450, 22 * (i % MaxEntriesPerPage) + 31, 137, 21, 0xBBC);
                    this.AddLabel(450, 22 * (i % MaxEntriesPerPage) + 31, texthue, locstr);
                    // display the map
                    this.AddImageTiled(571, 22 * (i % MaxEntriesPerPage) + 31, 70, 21, 0xBBC);
                    this.AddLabel(571, 22 * (i % MaxEntriesPerPage) + 31, texthue, mapstr);
                    // display the owner
                    this.AddImageTiled(640, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, 0xBBC);
                    this.AddLabelCropped(640, 22 * (i % MaxEntriesPerPage) + 31, 90, 21, texthue, ownstr);

                    // display the selection button

                    this.AddButton(730, 22 * (i % MaxEntriesPerPage) + 32, (e.Selected ? 0xD3 : 0xD2), (e.Selected ? 0xD2 : 0xD3), 4000 + i, GumpButtonType.Reply, 0);
                }
            }
        }
        ...
        public static ArrayList Search(SearchCriteria criteria, out string status_str)
        {
            ...
            if (!criteria.Dosearchattach)
            {
                ...
                lock (itemvalues.SyncRoot)
                {
                    ...
                    {
                        status_str = "Unable to search World.Items: " + e.Message;
                    }
                }
                ...
                if (itemarray != null)
                {
                    foreach (Item i in itemarray)
                    {
                        ...
                        if (criteria.Dosearchwithattach && !hasattach)
                            continue;
            ...
            if (!criteria.Dosearcherr && !criteria.Dosearchattach)
            {
                ...
                lock (mobilevalues.SyncRoot)
                {
                    ...
                    {
                        status_str = "Unable to search World.Mobiles: " + e.Message;
                    }
                }
        ...
        {
            if (info == null || state == null || state.Mobile == null || this.m_SearchCriteria == null)
                return;
            ...
            this.m_SearchCriteria.Searchage = 0;
            if (tr != null && tr.Text != null && tr.Text.Length > 0)
            {
                try
                {
                    this.m_SearchCriteria.Searchage = double.Parse(tr.Text);
                }
                catch
                {
                }
            ...
            this.m_SearchCriteria.Searchrange = -1;
            if (tr != null && tr.Text != null && tr.Text.Length > 0)
            {
                try
                {
                    this.m_SearchCriteria.Searchrange = int.Parse(tr.Text);
                }
                catch
                {
                }
            ...
            if (tr != null)
                this.m_SearchCriteria.Searchtype = tr.Text;

            tr = info.GetTextEntry(102);        // name info
            if (tr != null)
                this.m_SearchCriteria.Searchname = tr.Text;

            tr = info.GetTextEntry(125);        // attachment type info
            if (tr != null)
                this.m_SearchCriteria.Searchattachtype = tr.Text;

            tr = info.GetTextEntry(103);        // entry info
            if (tr != null)
                this.m_SearchCriteria.Searchspawnentry = tr.Text;

            tr = info.GetTextEntry(104);        // condition info
            if (tr != null)
                this.m_SearchCriteria.Searchcondition = tr.Text;

            tr = info.GetTextEntry(106);        // region info
            if (tr != null)
                this.m_SearchCriteria.Searchregion = tr.Text;
            ...
            if (tr != null)
                this.CommandString = tr.Text;

            // check all of the check boxes
            this.m_SearchCriteria.Searchagedirection = info.IsSwitched(302);
            this.m_SearchCriteria.Dosearchage = info.IsSwitched(303);
            this.m_SearchCriteria.Dosearchrange = info.IsSwitched(304);
            this.m_SearchCriteria.Dosearchtype = info.IsSwitched(305);
            this.m_SearchCriteria.Dosearchname = info.IsSwitched(306);
            this.m_SearchCriteria.Dosearchspawnentry = info.IsSwitched(307);
            this.m_SearchCriteria.Dosearchspawntype = info.IsSwitched(326);
            this.m_SearchCriteria.Dosearcherr = info.IsSwitched(313);
            this.m_SearchCriteria.Dosearchcondition = info.IsSwitched(315);

            this.m_SearchCriteria.Dosearchint = info.IsSwitched(312);
            this.m_SearchCriteria.Dosearchfel = info.IsSwitched(308);
            this.m_SearchCriteria.Dosearchtram = info.IsSwitched(309);
            this.m_SearchCriteria.Dosearchmal = info.IsSwitched(310);
            this.m_SearchCriteria.Dosearchilsh = info.IsSwitched(311);
            this.m_SearchCriteria.Dosearchtok = info.IsSwitched(318);
            this.m_SearchCriteria.Dosearchter = info.IsSwitched(327);
            this.m_SearchCriteria.Dosearchnull = info.IsSwitched(314);

            this.m_SearchCriteria.Dohidevalidint = info.IsSwitched(316);
            this.m_SearchCriteria.Dosearchwithattach = info.IsSwitched(317);
            this.m_SearchCriteria.Dosearchattach = info.IsSwitched(325);
            this.m_SearchCriteria.Dosearchregion = info.IsSwitched(319);
            ...
            switch (info.ButtonID)
            {
                ...
                case 3: // Search
                    {
                        ...
                        // do the search
                        this.m_SearchCriteria.Currentloc = state.Mobile.Location;
                        this.m_SearchCriteria.Currentmap = state.Mobile.Map;

                        //m_SearchList = Search(m_SearchCriteria, out status_str);
                        XmlFindThread tobj = new XmlFindThread(state.Mobile, this.m_SearchCriteria, this.CommandString);
                ...
                case 4: // SubSearch
                    {
                        // do the search
                        string status_str;
                        this.m_SearchList = Search(this.m_SearchCriteria, out status_str);
                        break;
                    }
                ...
                case 154: // Bring all selected objects to the current location
                    {
                        ...
                        state.Mobile.SendGump(new XmlConfirmBringGump(state.Mobile, this.m_SearchList));
                        return;
                    }
                case 155: // Return the player to the starting loc
                    {
                        this.m_From.Location = this.StartingLoc;
                        this.m_From.Map = this.StartingMap;
                        break;
                    }
                case 156: // Delete selected items
                    {
                        ...
                        state.Mobile.SendGump(new XmlConfirmDeleteGump(state.Mobile, this.m_SearchList));
                        return;
                    }
                ...
                case 159: // xmlsave selected spawners
                    {
                        this.SaveList(state.Mobile, this.SaveFilename);
                        break;
                    }
                case 160: // execute the command on the selected items
                    {
                        this.ExecuteCommand(state.Mobile, this.CommandString);
                        break;
                    }
                case 200: // gump extension
                    {
                        this.m_ShowExtension = !this.m_ShowExtension;
                        break;
                    }
                ...
                default:
                    {
                        if (info.ButtonID >= 1000 && info.ButtonID < 1000 + MaxEntries)
                        {
                            ...
                            // then go to it
                            this.DoGoTo(info.ButtonID - 1000 + this.DisplayFrom);
                        }
                        if (info.ButtonID >= 2000 && info.ButtonID < 2000 + MaxEntries)
                        {
                            // flag the entry selected
                            this.Selected = info.ButtonID - 2000;
                            // then open the gump
                            this.Refresh(state);
                            this.DoShowGump(info.ButtonID - 2000 + this.DisplayFrom);
                            return;
                        }
                        ...
                        if (info.ButtonID == 3999)
                        {
                            ...
                            if (this.m_SearchList != null)
                            {
                                for (int i = 0; i < MaxEntries; i++)
                                {
                                    if (i + this.DisplayFrom < this.m_SearchList.Count)
                                    {
                                        SearchEntry e = (SearchEntry)this.m_SearchList[i + this.DisplayFrom];
                        ...
                        if (info.ButtonID >= 4000 && info.ButtonID < 4000 + MaxEntries)
                        {
                            ...
                            if (this.m_SearchList != null && i >= 0 && this.m_SearchList.Count > i + this.DisplayFrom)
                            {
                                SearchEntry e = (SearchEntry)this.m_SearchList[i + this.DisplayFrom];
        ...
        {
            if (XmlAttach.FindAttachments(o) != null)
                return true;
        ...
        private static bool TestAge(object o, double age, bool direction)
        {
            ...
            if (o is Mobile)
            {
                ...
                if (direction)
                {
                    ...
                    if ((DateTime.Now - mob.CreationTime) > TimeSpan.FromHours(age))
                        return true;
                }
                else
                {
        ...
        private void DoGoTo(int index)
        {
            ...
            if (this.m_SearchList != null && index < this.m_SearchList.Count)
            {
                object o = ((SearchEntry)this.m_SearchList[index]).Object;
                if (o is Item)
                {
                    Item item = (Item)o;
                    Point3D itemloc;
                    ...
                    if (item == null || item.Deleted || item.Map == null || item.Map == Map.Internal)
                        return;
                    this.m_From.Location = itemloc;
                    this.m_From.Map = item.Map;
                }
                else if (o is Mobile)
                {
                    Mobile mob = (Mobile)o;
                    if (mob == null || mob.Deleted || mob.Map == null || mob.Map == Map.Internal)
                        return;
                    this.m_From.Location = mob.Location;
                    this.m_From.Map = mob.Map;
                }
                else if (o is XmlAttachment)
                {
        ...
        private void SortFindList()
        {
            if (this.m_SearchList != null && this.m_SearchList.Count > 0)
            {
                ...
                else if (this.Sortmap)
                {
                    this.m_SearchList.Sort(new ListMapSorter(this.Descendingsort));
                }
                else if (this.Sortrange)
                {
                    this.m_SearchList.Sort(new ListRangeSorter(this.m_From, this.Descendingsort));
                }
                else if (this.Sortselect)
                {
                    this.m_SearchList.Sort(new ListSelectSorter(this.m_From, this.Descendingsort));
                }
            }
        }
        ...
        private void ResetList()
        {
            ...
            {
                SearchEntry e = (SearchEntry)this.m_SearchList[i];
        ...
        public class XmlFindThread
        {
            ...
            public XmlFindThread(Mobile from, SearchCriteria criteria, string commandstring)
            {
                this.m_SearchCriteria = criteria;
                this.m_From = from;
                this.m_commandstring = commandstring;
            }
            ...
            public void XmlFindThreadMain()
            {
                ...
                ArrayList results = XmlFindGump.Search(this.m_SearchCriteria, out status_str);

                XmlFindGump gump = new XmlFindGump(this.m_From, this.m_From.Location, this.m_From.Map, true, true, false,
                    this.m_SearchCriteria,
                    results, -1, 0, null, this.m_commandstring,
                    false, false, false, false, false, false, 0, 0);

                // display the updated gump synched with the main server thread
                Timer.DelayCall(TimeSpan.Zero, new TimerStateCallback(GumpDisplayCallback), new object[] { this.m_From, gump, status_str });
            }
        ...
        public class SearchCriteria
        {
            ...
            {
                this.Dosearchtype = dotype;
                this.Dosearchname = doname;
                this.Dosearchrange = dorange;
                this.Dosearchregion = doregion;
                this.Dosearchspawnentry = doentry;
                this.Dosearchspawntype = doentrytype;
                this.Dosearchcondition = docondition;
                this.Dosearchfel = dofel;
                this.Dosearchtram = dotram;
                this.Dosearchmal = domal;
                this.Dosearchilsh = doilsh;
                this.Dosearchtok = dotok;
                this.Dosearchtok = doter;
                this.Dosearchint = doint;
                this.Dosearchnull = donull;
                this.Dosearcherr = doerr;
                this.Dosearchage = doage;
                this.Dosearchwithattach = dowithattach;
                this.Dosearchattach = doattach;
                this.Dohidevalidint = dohidevalid;
                this.Searchagedirection = agedirection;
                this.Searchage = age;
                this.Searchrange = range;
                this.Searchregion = region;
                this.Searchcondition = condition;
                this.Searchtype = type;
                this.Searchattachtype = attachtype;
                this.Searchname = name;
                this.Searchspawnentry = entry;
            }
        ...
        public class XmlConfirmBringGump : Gump
        {
                ...
                : base(0, 0)
            {
                ...
                if (this.SearchList != null)
                {
                    ...
                    {
                        if (((SearchEntry)this.SearchList[i]).Selected)
                            count++;
                    }
                }

                this.AddLabel(20, 225, 33, String.Format("Bring {0} objects to you?", count));
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                switch (info.ButtonID)
                {
                    default:
                        {
                            if (radiostate == 1 && this.SearchList != null)
                            { // accept
                                for (int i = 0; i < this.SearchList.Count; i++)
                                {
                                    SearchEntry e = (SearchEntry)this.SearchList[i];
        ...
        public class XmlConfirmDeleteGump : Gump
        {
                ...
                : base(0, 0)
            {
                ...
                this.AddLabel(20, 225, 33, String.Format("Delete {0} objects?", count));
                this.AddRadio(35, 255, 9721, 9724, false, 1); // accept/yes radio
                this.AddRadio(135, 255, 9721, 9724, true, 2); // decline/no radio
                this.AddHtmlLocalized(72, 255, 200, 30, 1049016, 0x7fff, false, false); // Yes
                this.AddHtmlLocalized(172, 255, 200, 30, 1049017, 0x7fff, false, false); // No
                            ...
                            { // accept
                                for (int i = 0; i < this.SearchList.Count; i++)
                                {
                                    ...
                                    if (e.Selected)
                                    {
                                        ...
                                        else if ((o is Mobile) && !(((Mobile)o).Player))
                                        {
                                            try
                                            {
                                                ((Mobile)o).Delete();
        ...
        private class ListRangeSorter : IComparer
        {
            ...
            public int Compare(object e1, object e2)
            {
                ...
                if (this.From == null || this.From.Deleted)
                    return 0;
                if (x is Item)
                {
                    xmap = ((Item)x).Map;
                ...
                if (xmap != this.From.Map && ymap != this.From.Map)
                    return 0;
                ...
                if (this.Dsort)
                {
                    ...
                    if (xmap != this.From.Map && ymap == this.From.Map)
                        return -1;
                    return this.From.GetDistanceToSqrt(yloc).CompareTo(this.From.GetDistanceToSqrt(xloc));
                }
                else
                {
                    if (xmap == this.From.Map && ymap != this.From.Map)
                    ...
                    if (xmap != this.From.Map && ymap == this.From.Map)
                        return 1;
                    return this.From.GetDistanceToSqrt(xloc).CompareTo(this.From.GetDistanceToSqrt(yloc));
                }
            }
        }
