...
namespace Server.Items
{
    public abstract class BaseSiegeWeapon : BaseAddon, ISiegeWeapon
    {
        ...
        public TimeSpan NextFiring
        {
            get
            {
                return this.m_NextFiringTime - DateTime.Now;
            }
            set
            {
                this.m_NextFiringTime = DateTime.Now + value;
            }
        }
        ...
        public virtual bool AttackTarget(Mobile from, IEntity target, Point3D targetloc, bool checkLOS)
        {
            ...
            this.m_NextFiringTime = DateTime.Now + TimeSpan.FromSeconds(loadingdelay);
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (this.m_NextFiringTime > DateTime.Now)
            {
