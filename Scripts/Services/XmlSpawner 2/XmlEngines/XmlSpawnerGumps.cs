            ...
            for (int i = 0; i < MaxSpawnEntries; i++)
            {
                ...
                if (i < this.m_Spawner.SpawnObjects.Length)
                {
                    ...
                    if (this.m_ShowGump > 1)
                    {
                        ...
                        if (this.m_Spawner.SpawnObjects[i].NextSpawn > DateTime.Now)
                        {
                            ...
                            if ((DateTime.Now + this.m_Spawner.NextSpawn) > this.m_Spawner.SpawnObjects[i].NextSpawn)
                            {
                            ...
                            else
                            {
                                ...
                                strnext = (this.m_Spawner.SpawnObjects[i].NextSpawn - DateTime.Now + this.m_Spawner.NextSpawn).ToString();
                            }
                        }
                        else
                        {
