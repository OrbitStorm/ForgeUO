...
namespace Server.Items
{
    public class DeathmatchGauntlet : BaseChallengeGame
    {
        ...
        public override void OnTick()
        {
            ...
            if (this.MatchLength > TimeSpan.Zero && DateTime.Now >= this.MatchStart + this.MatchLength)
            {
                this.CheckForGameEnd();
            }
            else if (this.MatchLength > TimeSpan.Zero && DateTime.Now >= this.MatchStart + this.MatchLength - TimeSpan.FromSeconds(10))
            {
                this.GameBroadcast((this.MatchStart + this.MatchLength - DateTime.Now).ToString());
            }
        }
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            {
                writer.Write(DateTime.Now - this.m_MatchStart);
            }
            else
            {
