...
namespace Server.Gumps
{
    public class CTFGump : Gump
    {
            ...
            : base(20, 30)
        {
            ...
            this.AddLabel(90, 10, 0, XmlPoints.GetText(from, 200620));  // "Team KotH Challenge"
            ...
            if (gauntlet.Participants != null)
            {
                ...
                this.AddLabel(220, 130, 0, String.Format("Page: {0}/{1}", this.viewpage + 1, (int)(this.m_WorkingList.Count / this.PlayersPerPage) + 1));
        ...
        private class MemberTarget : Target
        {
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Mobile && ((Mobile)targeted).Player)
                {
                    ...
                    if (this.m_gauntlet.Participants != null)
                    {
                        foreach (CTFGauntlet.ChallengeEntry entry in this.m_gauntlet.Participants)
                        {
                    ...
                    this.m_list.Add(new CTFGauntlet.ChallengeEntry(pm));
