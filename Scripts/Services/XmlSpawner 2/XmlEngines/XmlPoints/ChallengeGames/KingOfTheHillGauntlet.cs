...
namespace Server.Items
{
    public class KingOfTheHillGauntlet : BaseChallengeGame
    {
        ...
        public KingOfTheHillGauntlet(Mobile challenger)
            : base(0x1414)
        {
            ...
            {
                this.Name = XmlPoints.SystemText(100410) + " " + String.Format(XmlPoints.SystemText(100315), challenger.Name); // "Challenge by {0}"
            }
        }

        public KingOfTheHillGauntlet(Serial serial)
            : base(serial)
        {
        }
