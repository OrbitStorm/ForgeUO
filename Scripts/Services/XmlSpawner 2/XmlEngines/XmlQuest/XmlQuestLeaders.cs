...
namespace Server.Engines.XmlSpawner2
{
    public class XmlQuestLeaders
    {
        ...
        private static readonly string m_QuestLeaderboardSaveDirectory = "Leaderboard";     // default directory for saving quest leaderboard xml information
        ...
        public class QuestRankEntry : IComparable
        {
            ...
            {
                this.Quester = m;
                this.QuestPointsAttachment = attachment;
            }
            ...
            public int CompareTo(object obj)
            {
                ...
                if (p.QuestPointsAttachment == null || this.QuestPointsAttachment == null)
                    return 0;

                // break points ties with quests completed (more quests means higher rank)
                if (p.QuestPointsAttachment.Points - this.QuestPointsAttachment.Points == 0)
                {
                    // if kills are the same then compare previous rank 
                    if (p.QuestPointsAttachment.QuestsCompleted - this.QuestPointsAttachment.QuestsCompleted == 0)
                    { 
                        return p.QuestPointsAttachment.Rank - this.QuestPointsAttachment.Rank;					
                    }

                    return p.QuestPointsAttachment.QuestsCompleted - this.QuestPointsAttachment.QuestsCompleted;
                }

                return p.QuestPointsAttachment.Points - this.QuestPointsAttachment.Points;
            }
        }
        ...
        private class QuestLeaderboardTimer : Timer
        {
            ...
            {
                WriteQuestLeaderboard(this.m_filename, this.m_nranks);
            }
        }

        private readonly string guildFilter = null;
        private readonly string nameFilter = null;
        ...
        public class TopQuestPlayersGump : Gump
        {
                ...
                : base(0,0)
            {
                ...
                this.AddLabel(20, 2, 55, "Top Quest Player Rankings"); 

                // guild filter
                this.AddLabel(40, height - 20, 55, "Filter by Guild");  
                string filter = null;
                ...
                // name filter
                this.AddLabel(340, height - 20, 55, "Filter by Name");  // 
                string nfilter = null;
                if (this.m_attachment != null)
                ...
                int xloc = 23;
                this.AddLabel(xloc, 20, 0, "Name");  
                xloc += 177;
                this.AddLabel(xloc, 20, 0, "Guild");  
                #if(FACTIONS)
                xloc += 35;
                this.AddLabel(xloc, 20, 0, "Faction");  
                xloc += 15;
                #endif
                xloc += 50;
                this.AddLabel(xloc, 20, 0, "Points");   
                xloc += 50;
                this.AddLabel(xloc, 20, 0, "Quests");
                xloc += 50;
                //AddLabel( xloc, 20, 0, "" );
                xloc += 70;
                this.AddLabel(xloc, 20, 0, "Rank");     
                xloc += 45;
                this.AddLabel(xloc, 20, 0, "Change");  
                xloc += 45;
                this.AddLabel(xloc, 20, 0, "Time at Rank");  
                ...
                for (int i = 0; i < QuestRankList.Count; i++)
                {
                    ...
                    if (r.Quester != null && !r.Quester.Deleted && r.Rank > 0 && a != null && !a.Deleted)
                    {
                        ...
                        xloc = 23;
                        this.AddLabel(xloc, y, 0, r.Quester.Name);
                        xloc += 177;
            ...
            public override void OnResponse(NetState state, RelayInfo info)
            {
                ...
                switch(info.ButtonID)
                {
                    ...
                    case 200:
                        {
                            // redisplay the gump
                            state.Mobile.SendGump(new TopQuestPlayersGump(this.m_attachment));
                            break;
                        }
                }
            }
