...
namespace Server.Mobiles
{
    public class BasePeerless : BaseCreature
    {
        ...
        public override void OnThink()
        {
            ...
            if (this.HasFireRing && this.Combatant != null && this.Alive && this.Hits > 0.8 * this.HitsMax && this.m_NextFireRing < DateTime.Now && Utility.RandomDouble() < this.FireRingChance)
                this.FireRing();
        ...
        {
            this.m_NextFireRing = DateTime.Now + TimeSpan.FromSeconds(10);			
