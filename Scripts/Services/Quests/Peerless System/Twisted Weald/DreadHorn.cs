...
namespace Server.Mobiles
{
    ...
    { 
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            this.m_Change = DateTime.Now;
            this.m_Stomp = DateTime.Now;
        }
        ...
        public override void OnThink()
        {
            ...
            {
                if (this.m_Change < DateTime.Now && Utility.RandomDouble() < 0.2)
                    this.ChangeOpponent();					
				
                if (this.m_Stomp < DateTime.Now && Utility.RandomDouble() < 0.1)
                    this.HoofStomp();
            }
        ...
        public void ChangeOpponent()
        {
            ...
            if (best != null)
            {
                ...
                this.m_Change = DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(5, 10));
            }
        }
        ...
        { 
            ...
            this.m_Stomp = DateTime.Now + TimeSpan.FromSeconds(Utility.RandomMinMax(40, 50));
        }
