...
namespace Server.Mobiles
{
    ...
    public class SlasherOfVeils : BaseSABosses
    {
        ...
        public override Type[] UniqueSAList
        {
            get
            {
                return new Type[] { typeof(ClawsOfTheBerserker), typeof(Lavaliere), typeof(Mangler), typeof(SignOfChaos), typeof(StandardOfChaosG), typeof(StandardOfChaos) };
            }
        }
        ...
        public override void OnMovement(Mobile m, Point3D oldLocation)
        {
            ...
            if (this.m_NextTerror < DateTime.Now && m != null && this.InRange(m.Location, 10) && m.IsPlayer())
            {
                m.Frozen = true;
        ...
        private void Terrorize(object o)
        {
            if (o is Mobile)
            {
                ...
                this.m_NextTerror = DateTime.Now + TimeSpan.FromMinutes(1);
            }
        }
    }
}