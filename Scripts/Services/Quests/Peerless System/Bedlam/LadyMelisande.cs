...
namespace Server.Mobiles
{
    ...
    public class LadyMelisande : BasePeerless
    {
        ...
        {
            if (this.m_NextSmackTalk > DateTime.Now)
                return false;
        ...
        public void SmackTalk()
        {
            ...
            this.m_NextSmackTalk = DateTime.Now + TimeSpan.FromSeconds(2 + Utility.RandomDouble() * 3);	
        }
        ...
        {
            if (this.m_NextPutridNausea > DateTime.Now)
                return false;
        ...
        public void PutridNausea()
        {
            ...
            this.m_NextPutridNausea = DateTime.Now + TimeSpan.FromSeconds(40 + Utility.RandomDouble() * 30);
        }
        ...
        {
            if (this.m_NextTakeLife > DateTime.Now)
                return false;
        ...
        public void TakeLife(Mobile from)
        {
            ...
            this.m_NextTakeLife = DateTime.Now + TimeSpan.FromSeconds(15 + Utility.RandomDouble() * 45);
        }
