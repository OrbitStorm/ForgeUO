        ...
        private class DiscordanceInfo
        {
            ...
            public void Apply()
            {
                for (int i = 0; i < this.m_Mods.Count; ++i)
                {
                    ...
                    if (mod is ResistanceMod)
                        this.m_Creature.AddResistanceMod((ResistanceMod)mod);
                    else if (mod is StatMod)
                        this.m_Creature.AddStatMod((StatMod)mod);
                    else if (mod is SkillMod)
                        this.m_Creature.AddSkillMod((SkillMod)mod);
                }
            }
            ...
            public void Clear()
            {
                for (int i = 0; i < this.m_Mods.Count; ++i)
                {
                    ...
                    if (mod is ResistanceMod)
                        this.m_Creature.RemoveResistanceMod((ResistanceMod)mod);
                    else if (mod is StatMod)
                        this.m_Creature.RemoveStatMod(((StatMod)mod).Name);
                    else if (mod is SkillMod)
                        this.m_Creature.RemoveSkillMod((SkillMod)mod);
                }
            }
        }
    }
