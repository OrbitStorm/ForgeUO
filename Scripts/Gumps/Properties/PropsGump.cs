    ...
    public class PropertiesGump : Gump
    {
        ...
        private void Initialize(int page)
        {
            ...
            if (TypeLabel && this.m_Type != null)
                this.AddHtml(x, y, emptyWidth, EntryHeight, String.Format("<BASEFONT COLOR=#FAFAFA><CENTER>{0}</CENTER></BASEFONT>", this.m_Type.Name), false, false);
        ...
        private ArrayList BuildList()
        {
            ...
            ArrayList groups = this.GetGroups(this.m_Type, props);
