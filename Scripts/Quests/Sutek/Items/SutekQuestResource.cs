    ...
    public class SutekQuestResource : Item
    {
        ...
        */
        ...
        public SutekResourceType ActualType
        {
            get
            {
                return (SutekResourceType)m_Table[(int)this.m_Type][0];
            }
        }
        ...
        {
            this.LabelTo(from, this.m_Label);
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            {
                case 1:
                    this.m_Type = (SutekResourceType)reader.ReadInt();
                    break;
            }
        }
        ...
        private void Update()
        {
            int[] vals = m_Table[(int)this.m_Type];
