...
namespace Server
{
    ...
    public class Skill
    {
        ...
        public Skill(Skills owner, SkillInfo info, GenericReader reader)
        {
            ...
            if (this.m_Lock < SkillLock.Up || this.m_Lock > SkillLock.Locked)
            {
                Console.WriteLine("Bad skill lock -> {0}.{1}", owner.Owner, this.m_Lock);
                this.m_Lock = SkillLock.Up;
            }
        }
        ...
        public int BaseFixedPoint
        {
            ...
            set
            {
                ...
                int oldBase = this.m_Base;

                if (this.m_Base != sv)
                {
                    this.m_Owner.Total = (this.m_Owner.Total - this.m_Base) + sv;

                    this.m_Base = sv;

                    this.m_Owner.OnSkillChange(this);

                    Mobile m = this.m_Owner.Owner;

                    if (m != null)
                        m.OnSkillChange(this.SkillName, (double)oldBase / 10);
                }
            }
        }
        ...
        public double Value
        {
            get
            {
                ...
                double raceBonus = this.m_Owner.Owner.RacialSkillBonus;
        ...
        public double NonRacialValue
        {
            get
            {
                ...
                double statsOffset = ((m_UseStatMods ? this.m_Owner.Owner.Str : this.m_Owner.Owner.RawStr) * this.m_Info.StrScale) + ((m_UseStatMods ? this.m_Owner.Owner.Dex : this.m_Owner.Owner.RawDex) * this.m_Info.DexScale) + ((m_UseStatMods ? this.m_Owner.Owner.Int : this.m_Owner.Owner.RawInt) * this.m_Info.IntScale);
                double statTotal = this.m_Info.StatTotal * inv;
                ...
                List<SkillMod> mods = this.m_Owner.Owner.SkillMods;
                ...
                for (int i = 0; i < mods.Count; ++i)
                {
                    ...
                    if (mod.Skill == (SkillName)this.m_Info.SkillID)
                    {
                        if (mod.Relative)
                        {
                            if (mod.ObeyCap)
    ...
    public class Skills : IEnumerable
    {
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Bushido
        {
            get
            {
                return this[SkillName.Bushido];
            }
            set
            {
            }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Ninjitsu
        {
            get
            {
                return this[SkillName.Ninjitsu];
            }
            set
            {
            }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Spellweaving
        {
            get
            {
                return this[SkillName.Spellweaving];
            }
            set
            {
            }
        ...
        public Skill Mysticism
        {
            get
            {
                return this[SkillName.Mysticism];
            }
            set
            {
            }
        ...
        [CommandProperty(AccessLevel.Counselor)]
        public Skill Imbuing
        {
            get
            {
                return this[SkillName.Imbuing];
            }
            set
            {
            }
        ...
        public Skill Throwing
        {
            get
            {
                return this[SkillName.Throwing];
            }
            set
            {
            }
        ...
        public Skill this[int skillID]
        {
            get
            {
                ...
                Skill sk = this.m_Skills[skillID];

                if (sk == null)
                    this.m_Skills[skillID] = sk = new Skill(this, SkillInfo.Table[skillID], 0, 1000, SkillLock.Up);
        ...
        public Skill Highest
        {
            get
            {
                if (this.m_Highest == null)
                {
                    ...
                    if (highest == null && this.m_Skills.Length > 0)
                        highest = this[0];

                    this.m_Highest = highest;
                }
        ...
        public void Serialize(GenericWriter writer)
        {
            ...
            writer.Write((int)this.m_Cap);
            writer.Write((int)this.m_Skills.Length);
            ...
            for (int i = 0; i < this.m_Skills.Length; ++i)
            {
                ...
                {
                    sk.Serialize(writer);
                    this.m_Total += sk.BaseFixedPoint;
                }
            }
        }
        ...
        public Skills(Mobile owner)
        {
            ...
            this.m_Skills = new Skill[info.Length];
        ...
        {
            if (skill == this.m_Highest) // could be downgrading the skill, force a recalc
                this.m_Highest = null;
            ...
            NetState ns = this.m_Owner.NetState;
        ...
        {
            return this.m_Skills.GetEnumerator();
        }
    }
}