...
namespace Server.Network
{
    ...
    public class PacketWriter
    {
        ...
        public void WriteAsciiFixed(string value, int size)
        {
            ...
            if (length >= size)
                this.m_Stream.Position += Encoding.ASCII.GetBytes(value, 0, size, this.m_Stream.GetBuffer(), (int)this.m_Stream.Position);
            else
            {
                Encoding.ASCII.GetBytes(value, 0, length, this.m_Stream.GetBuffer(), (int)this.m_Stream.Position);
                this.m_Stream.Position += size;
            }
        ...
        public void WriteAsciiNull(string value)
        {
            ...
            this.m_Stream.SetLength(this.m_Stream.Length + length + 1);

            Encoding.ASCII.GetBytes(value, 0, length, this.m_Stream.GetBuffer(), (int)this.m_Stream.Position);
            this.m_Stream.Position += length + 1;
            /*byte[] buffer = Encoding.ASCII.GetBytes( value );
            m_Stream.Write( buffer, 0, buffer.Length );
        ...
        public void WriteLittleUniNull(string value)
        {
            ...
            this.m_Stream.SetLength(this.m_Stream.Length + ((length + 1) * 2));

            this.m_Stream.Position += Encoding.Unicode.GetBytes(value, 0, length, this.m_Stream.GetBuffer(), (int)this.m_Stream.Position);
        ...
        public void WriteLittleUniFixed(string value, int size)
        {
            ...
            {
                Encoding.Unicode.GetBytes(value, 0, length, this.m_Stream.GetBuffer(), (int)this.m_Stream.Position);
                this.m_Stream.Position += size;
            }
            /*size *= 2;
            byte[] buffer = Encoding.Unicode.GetBytes( value );
        ...
        public void WriteBigUniNull(string value)
        {
            ...
            this.m_Stream.Position += Encoding.BigEndianUnicode.GetBytes(value, 0, length, this.m_Stream.GetBuffer(), (int)this.m_Stream.Position);
            this.m_Stream.Position += 2;
        ...
        public void WriteBigUniFixed(string value, int size)
        {
            ...
            {
                Encoding.BigEndianUnicode.GetBytes(value, 0, length, this.m_Stream.GetBuffer(), (int)this.m_Stream.Position);
                this.m_Stream.Position += size;
            }
            /*size *= 2;
            byte[] buffer = Encoding.BigEndianUnicode.GetBytes( value );
