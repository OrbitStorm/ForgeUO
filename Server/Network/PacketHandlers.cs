...
namespace Server.Network
{
	...
	public static class PacketHandlers
	{
		...
		public static bool SingleClickProps
		{
			get
			{
				return m_SingleClickProps;
			}
			set
			{
				m_SingleClickProps = value;
			}
		}
		...
		public static int[] ValidAnimations
		{
			get
			{
				return m_ValidAnimations;
			}
			set
			{
				m_ValidAnimations = value;
			}
		}
		...
		private class LoginTimer : Timer
		{
			...
			protected override void OnTick()
			{
				if (this.m_State == null)
					this.Stop();
				if (this.m_State.Version != null)
				{
					this.m_State.BlockAllPackets = false;
					DoLogin(this.m_State, this.m_Mobile);
					this.Stop();
				}
			}
		}
